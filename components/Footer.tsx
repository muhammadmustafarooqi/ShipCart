              ...
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="footer-link">
                    <span className="footer-link-arrow">&rarr;</span> {l.label}
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "12px" }}>
              {[
                ...
                <li key={c.slug}>
                  <Link href={`/products?category=${c.slug}`} className="footer-link">
                    <span className="footer-link-arrow">&rarr;</span> {c.label}
                  </Link>
                </li>
              ))}
            </ul>
        ...
        <div className="page-container" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "16px", width: "100%" }}>
          ...
          <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
            {["Privacy Policy", "Terms of Service", "Return Policy"].map((item) => (
              <a key={item} href="#" className="footer-policy">
                {item}
              </a>
            ))}
          </div>
